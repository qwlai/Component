    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (i = 0; i < numtuple; i++) {
                ...
                if (i != numtuple - 1) outtbl.println();
            }
            outtbl.close();

            // System.out.println("end of table generation");
            /** printing the number of distinct values of each column in <tablename>.stat file */
            for (i = 0; i < numCol; i++) {
                if (datatype[i].equals("STRING")) {
                    ...
                    if (keytype[i].equals("PK")) {
                        ...
                        if (numtuple < range[i]) outstat.print(numtuple + "\t");
                        else outstat.print(range[i] + "\t");
                    }
                }
            }
            outstat.close();

...
public class Scan extends Operator {
    ...
    public Batch next() {
        ...
        while (!tuples.isFull()) {
            try {
                ...
                /** At this point incomplete page is sent and at next call it considered * as end of file */
                eos = true;
                return tuples;
            } catch (IOException e) {
    ...
    /** Close the file.. This routine is called when the end of filed * is already reached */

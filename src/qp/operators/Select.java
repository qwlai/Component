...
public class Select extends Operator {
    ...
    /**
     * returns a batch of tuples that satisfies the * condition specified on the tuples coming from
     * base operator * NOTE: This operation is performed on the fly
     */
    public Batch next() {
        ...
        while (!outbatch.isFull()) {
            ...
            /**
             * Modify the cursor to the position requierd * when the base operator is called next time;
             */
            if (i == inbatch.size()) start = 0;
            else start = i;

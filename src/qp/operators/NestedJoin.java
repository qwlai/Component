...
public class NestedJoin extends Join {
    ...
    /**
     * During open finds the index of the join attributes * Materializes the right hand side into a
     * file * Opens the connections
     */
    public boolean open() {
        ...
        eosl = false;
        /**
         * because right stream is to be repetitively scanned * if it reached end, we have to start new
         * scan
         */
        eosr = true;

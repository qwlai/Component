...
public class PlanCost {
    ...
    protected int getStatistics(Join node) {
        ...
        /**
         * get size of the tuple in output & correspondigly calculate * buffer capacity, i.e., number of
         * tuples per page *
         */
    ...
    protected int getStatistics(Select node) {
        ...
        /**
         * Modify the number of distinct values of each attribute * Assuming the values are distributed
         * uniformly along entire * relation
         */
